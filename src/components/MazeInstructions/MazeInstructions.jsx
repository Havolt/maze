...
function MazeInstructions() {
  return (
    <div className={Styles.MazeInstructions}>
      ...
      <p>Your challenge is to find your way from room 1 (after the Prologue) to room 45 and then back to room 1 using the shortest possible path. If you use your head, you should be able to make the journey in only sixteen steps.</p>

      <p>There are any number of clues in the drawings and in the story to help you choose the right door in each room. Clues in a series of rooms may relate to each one another, and may indicate a path. Other clues may refer to a specific door in a single room.</p>
